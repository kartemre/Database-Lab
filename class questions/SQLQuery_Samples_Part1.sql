...
-- SORU 3 --
SELECT * FROM CUSTOMERS
WHERE CUSTOMERNAME LIKE 'A%' OR GENDER='E'
...
SELECT * FROM CUSTOMERS
WHERE BIRTHDATE>='01.01.1990' AND BIRTHDATE<='01.01.1995'
ORDER BY BIRTHDATE
...
SELECT DATEPART(YEAR,'01.03.2022')
SELECT DATEPART(MONTH,'01.03.2022')
SELECT DATEPART(DAY,'01.03.2022')

-- SORU 5 --
SELECT C.*, CT.CITY 
FROM CUSTOMERS C, CITIES CT
WHERE C.CITYID=CT.ID AND CT.CITY='�STANBUL'
...
-- SORU 6 -- 
SELECT C.*, (SELECT CT.CITY FROM CITIES CT WHERE CT.ID=C.CITYID) AS CCITY
FROM CUSTOMERS C
WHERE (SELECT CT.CITY FROM CITIES CT WHERE CT.ID=C.CITYID)='�STANBUL'


SELECT C.*
FROM CUSTOMERS C
WHERE C.CITYID IN(SELECT CT.ID
				FROM CITIES CT
				WHERE CT.CITY='�STANBUL')
