...
CREATE PROCEDURE CustomerOrdersDetails
    @CustomerID INT
AS
BEGIN
...
EXEC CustomerOrdersDetails @CustomerID = 1;
...
CREATE PROCEDURE HighestOrderForCustomer
...
EXEC HighestOrderForCustomer @CustomerName = "debra";
